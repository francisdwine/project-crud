...
export default function Table() {
    ...
    const countryBodyTemplate = (rowData: Customer) => {
        return (
            <div className="flex align-items-center gap-2">
                <img alt={rowData.country} src="https://primefaces.org/cdn/primereact/images/flag/flag_placeholder.png" className={`flag flag-${rowData.country.code}`} style={{ width: '24px' }} />
    ...
    const representativeBodyTemplate = (rowData: Customer) => {
        ...
        return (
            <div className="flex align-items-center gap-2">
                <img alt={representative} src={`https://primefaces.org/cdn/primereact/images/avatar/${representative}`} width="32" />
